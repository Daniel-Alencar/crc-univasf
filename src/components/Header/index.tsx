...
import { FiMenu, FiX } from 'react-icons/fi'; // Ícones de hamburger e fechar
  ...
  return (
    <>
      <header className="lg:hidden bg-white shadow-md">
        <div className="container mx-auto flex justify-between items-center py-4 px-6">
          {/* Logo */}
          <div className="lg:hidden flex items-center text-2xl font-bold">
        ...
        {/* Menu mobile */}
        {isOpen && (
          <nav className="lg:hidden bg-gradient-to-r from-orange-500 to-yellow-400 px-6 py-4 shadow-lg">
      ...
      <header className="bg-white shadow-md">
        <div className="lg:flex container mx-auto flex justify-between items-center py-4 px-6">
          <div className="flex items-center text-2xl font-bold">
            <Image src={Logo} alt='crc univasf' />
          </div>
        </div>
