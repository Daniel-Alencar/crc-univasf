...
export default function NewsPage() {
  ...
  return (
    <div className="bg-[#FFE3AF] min-h-screen">
      {/* Banner com título e barra de pesquisa */}
      <div className="bg-gradient-to-r from-yellow-400 to-orange-500 py-6 px-4 md:px-8">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
          <h1 className="text-xl md:text-2xl font-bold text-black mb-4 md:mb-0 text-center md:text-left">
      ...
      <div className="container mx-auto py-8 px-4">
        ...
        <div className="mt-16">
          <h2 className="text-3xl font-bold text-center mb-12">NOTÍCIAS DESTAQUE</h2>
